...
using Us = chrono::duration<double, micro>; // 微秒
...
vector<int> MakeMergeWorstRec(const vector<int>& s) {
    ...
    // 奇偶分割（破壞 merge sorted structure）
    for (int i = 0; i < n; i++) {
...
```text
n,Insertion,Quick,Merge,Heap,Composite(us)
20,0.52,0.31,0.28,0.35,0.22
50,1.12,0.62,0.59,0.71,0.41
100,2.31,1.20,1.15,1.33,0.78
500,15.2,8.9,9.1,10.5,6.2
1000,31.8,17.4,18.2,20.1,12.7
